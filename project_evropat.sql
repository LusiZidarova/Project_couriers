...
CREATE PROCEDURE `insert_Or_Update_Vehicle`(
  vehicle_id_In INT(11),
  brand_In VARCHAR(255),
  model_In VARCHAR(255),
  regnumber_In VARCHAR(255),
  fuelconsumption_In DECIMAL(5,2),
  office_id_In INT(10),
  employee_id_In INT(10)
)
BEGIN
...
CREATE TABLE `office_to_town` (
	...
	`address` VARCHAR(202) NULL COLLATE 'utf8_general_ci',
	`town_id` INT(11) UNSIGNED NOT NULL,
